...
By fetching and processing these events you can reconstruct `users` service state. If you store some of your custom data in `metadata` field, this is the perfect way to fetch it and process it. If you want to integrate through [docker-compose.yml][mf-docker-compose] you can use `magistrala-es-redis` service. Just connect to it and consume events from Redis Stream named `magistrala.users`.
...
By fetching and processing these events you can reconstruct `things` service state. If you store some of your custom data in `metadata` field, this is the perfect way to fetch it and process it. If you want to integrate through [docker-compose.yml][mf-docker-compose] you can use `magistrala-es-redis` service. Just connect to it and consume events from Redis Stream named `magistrala.things`.
...
If you want to integrate through [docker-compose.yml][mf-docker-compose] you can use `magistrala-es-redis` service. Just connect to it and consume events from Redis Stream named `magistrala.mqtt`.
